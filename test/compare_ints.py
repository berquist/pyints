...
EFG1XX_pyints = np.loadtxt('pyints.EFG1XX.txt')
EFG1YY_pyints = np.loadtxt('pyints.EFG1YY.txt')
EFG1ZZ_pyints = np.loadtxt('pyints.EFG1ZZ.txt')
EFG1XY_pyints = np.loadtxt('pyints.EFG1XY.txt')
EFG1XZ_pyints = np.loadtxt('pyints.EFG1XZ.txt')
EFG1YZ_pyints = np.loadtxt('pyints.EFG1YZ.txt')
EFG2XX_pyints = np.loadtxt('pyints.EFG2XX.txt')
EFG2YY_pyints = np.loadtxt('pyints.EFG2YY.txt')
EFG2ZZ_pyints = np.loadtxt('pyints.EFG2ZZ.txt')
EFG2XY_pyints = np.loadtxt('pyints.EFG2XY.txt')
EFG2XZ_pyints = np.loadtxt('pyints.EFG2XZ.txt')
EFG2YZ_pyints = np.loadtxt('pyints.EFG2YZ.txt')
...
EFG1XX_dalton = np.loadtxt('dalton.xxefg011.txt')
EFG1YY_dalton = np.loadtxt('dalton.yyefg011.txt')
EFG1ZZ_dalton = np.loadtxt('dalton.zzefg011.txt')
EFG1XY_dalton = np.loadtxt('dalton.xyefg011.txt')
EFG1XZ_dalton = np.loadtxt('dalton.xzefg011.txt')
EFG1YZ_dalton = np.loadtxt('dalton.yzefg011.txt')
EFG2XX_dalton = np.loadtxt('dalton.xxefg021.txt')
EFG2YY_dalton = np.loadtxt('dalton.yyefg021.txt')
EFG2ZZ_dalton = np.loadtxt('dalton.zzefg021.txt')
EFG2XY_dalton = np.loadtxt('dalton.xyefg021.txt')
EFG2XZ_dalton = np.loadtxt('dalton.xzefg021.txt')
EFG2YZ_dalton = np.loadtxt('dalton.yzefg021.txt')
...
# npt.assert_allclose(EFG1XX_dalton, EFG1XX_pyints, rtol=1e-7, atol=1e-5)
# npt.assert_allclose(EFG1YY_dalton, EFG1YY_pyints, rtol=1e-7, atol=1e-5)
# npt.assert_allclose(EFG1ZZ_dalton, EFG1ZZ_pyints, rtol=1e-7, atol=1e-5)
# npt.assert_allclose(EFG1XY_dalton, EFG1XY_pyints, rtol=1e-7, atol=1e-5)
# npt.assert_allclose(EFG1XZ_dalton, EFG1XZ_pyints, rtol=1e-7, atol=1e-5)
# npt.assert_allclose(EFG1YZ_dalton, EFG1YZ_pyints, rtol=1e-7, atol=1e-5)
# npt.assert_allclose(EFG2XX_dalton, EFG2XX_pyints, rtol=1e-7, atol=1e-5)
# npt.assert_allclose(EFG2YY_dalton, EFG2YY_pyints, rtol=1e-7, atol=1e-5)
# npt.assert_allclose(EFG2ZZ_dalton, EFG2ZZ_pyints, rtol=1e-7, atol=1e-5)
# npt.assert_allclose(EFG2XY_dalton, EFG2XY_pyints, rtol=1e-7, atol=1e-5)
# npt.assert_allclose(EFG2XZ_dalton, EFG2XZ_pyints, rtol=1e-7, atol=1e-5)
# npt.assert_allclose(EFG2YZ_dalton, EFG2YZ_pyints, rtol=1e-7, atol=1e-5)
...
# npt.assert_allclose(abs(J2X_dalton), abs(J2X_pyints), rtol=1e-7, atol=1e-5)
# npt.assert_allclose(abs(J2Y_dalton), abs(J2Y_pyints), rtol=1e-7, atol=1e-5)
# npt.assert_allclose(abs(J2Z_dalton), abs(J2Z_pyints), rtol=1e-7, atol=1e-5)
