...
def compare_programs_runner(test_case_dirname):
    ...
    EFG1XX_pyints = loadtxt(os.path.join(
        test_case_dirname, 'pyints.EFG1XX.txt'))
    EFG1YY_pyints = loadtxt(os.path.join(
        test_case_dirname, 'pyints.EFG1YY.txt'))
    EFG1ZZ_pyints = loadtxt(os.path.join(
        test_case_dirname, 'pyints.EFG1ZZ.txt'))
    EFG1XY_pyints = loadtxt(os.path.join(
        test_case_dirname, 'pyints.EFG1XY.txt'))
    EFG1XZ_pyints = loadtxt(os.path.join(
        test_case_dirname, 'pyints.EFG1XZ.txt'))
    EFG1YZ_pyints = loadtxt(os.path.join(
        test_case_dirname, 'pyints.EFG1YZ.txt'))
    EFG2XX_pyints = loadtxt(os.path.join(
        test_case_dirname, 'pyints.EFG2XX.txt'))
    EFG2YY_pyints = loadtxt(os.path.join(
        test_case_dirname, 'pyints.EFG2YY.txt'))
    EFG2ZZ_pyints = loadtxt(os.path.join(
        test_case_dirname, 'pyints.EFG2ZZ.txt'))
    EFG2XY_pyints = loadtxt(os.path.join(
        test_case_dirname, 'pyints.EFG2XY.txt'))
    EFG2XZ_pyints = loadtxt(os.path.join(
        test_case_dirname, 'pyints.EFG2XZ.txt'))
    EFG2YZ_pyints = loadtxt(os.path.join(
        test_case_dirname, 'pyints.EFG2YZ.txt'))
    ...
    V_nn_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.nuclear_repulsion_energy.txt'))
    E_total_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.total_energy.txt'))
    M001_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.zdiplen.txt'))
    M002_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.zzsecmom.txt'))
    M010_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.ydiplen.txt'))
    M011_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.yzsecmom.txt'))
    M020_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.yysecmom.txt'))
    M100_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.xdiplen.txt'))
    M101_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.xzsecmom.txt'))
    M110_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.xysecmom.txt'))
    M200_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.xxsecmom.txt'))
    EF001_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.nef001.txt'))
    EF002_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.nef002.txt'))
    EF003_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.nef003.txt'))
    EF004_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.nef004.txt'))
    EF005_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.nef005.txt'))
    EF006_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.nef006.txt'))
    EFG1XX_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.xxefg011.txt'))
    EFG1YY_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.yyefg011.txt'))
    EFG1ZZ_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.zzefg011.txt'))
    EFG1XY_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.xyefg011.txt'))
    EFG1XZ_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.xzefg011.txt'))
    EFG1YZ_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.yzefg011.txt'))
    EFG2XX_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.xxefg021.txt'))
    EFG2YY_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.yyefg021.txt'))
    EFG2ZZ_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.zzefg021.txt'))
    EFG2XY_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.xyefg021.txt'))
    EFG2XZ_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.xzefg021.txt'))
    EFG2YZ_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.yzefg021.txt'))
    ...
    J1X_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.x1spnorb.txt'))
    J1Y_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.y1spnorb.txt'))
    J1Z_dalton = loadtxt(os.path.join(
        test_case_dirname, 'dalton.z1spnorb.txt'))
    # ERI_dalton = load()
